  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> Jellyfish </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/MashiroSaberj/site-status",
  home: "https://github.com/MashiroSaberj",
  email: "catshumumu@outlook.com",
};
</script>
